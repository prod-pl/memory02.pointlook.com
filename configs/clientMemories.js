...
//];
var MY_MEMORY = !window || !window.location || !window.location.protocol || !window.location.host ? 'https://prod-pl-admin.193b.starter-ca-central-1.openshiftapps.com/gun' : window.location.protocol + '//' + window.location.host + '/gun';
